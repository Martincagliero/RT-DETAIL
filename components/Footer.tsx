...
export default function Footer() {
  return (
    <footer className="relative bg-deep-black overflow-hidden">
      ...
      <div className="relative py-32 md:py-40 lg:py-48 px-4 md:px-8 lg:px-16">
        ...
        >
          {/* Title */}
          <h2 className="font-display text-5xl md:text-7xl lg:text-8xl metallic-text mb-6 md:mb-8">
            AGENDÁ TU TURNO
          </h2>

          {/* Subtitle */}
          <p className="text-white/70 text-lg md:text-xl mb-16 md:mb-20 tracking-wide max-w-2xl mx-auto">
            Contactá con nosotros mediante tu canal preferido y reservá tu turno para una experiencia de detailing premium
          </p>

          {/* Buttons Container */}
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 justify-center items-stretch md:items-center">
            {/* Email Button */}
            <motion.a
              ...
              className="group relative px-8 md:px-10 py-4 md:py-5 bg-gradient-to-br from-gray-100 to-gray-200 text-deep-black font-semibold tracking-wide rounded-[14px] overflow-hidden transition-all duration-300 inline-flex items-center justify-center gap-3 min-w-[280px] md:min-w-auto shadow-lg hover:shadow-xl"
            ...
            >
              ...
              <span className="relative z-10 text-sm md:text-base font-semibold">ENVIAR MAIL</span>
              <motion.div
            ...
            <motion.a
              ...
              className="group relative px-8 md:px-10 py-4 md:py-5 bg-gradient-to-br from-[#25D366] to-[#20ba5a] text-white font-semibold tracking-wide rounded-[14px] overflow-hidden transition-all duration-300 inline-flex items-center justify-center gap-3 min-w-[280px] md:min-w-auto shadow-lg hover:shadow-xl"
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
            >
              {/* SVG Icon */}
              ...
              <span className="relative z-10 text-sm md:text-base font-semibold">WHATSAPP</span>
              <motion.div
      ...
      <motion.a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-8 right-8 z-40 w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl transition-all duration-300 group"
        animate={{
          y: [0, -10, 0],
        }}
        transition={{
